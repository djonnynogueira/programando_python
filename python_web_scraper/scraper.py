# Raspagem da Web com Python: Guia Passo-a-Passo

# https://brightdata.com.br/blog/procedimentos/web-scraping-with-python

# A biblioteca Requests permite-lhe realizar pedidos HTTP em Python
# pip install requests

# A biblioteca Beautiful Soup de Python torna mais fácil raspar informação de páginas web
# pip install beautifulsoup4

# Selenium é uma estrutura de testes automatizada, avançada e de código aberto que lhe permite executar operações numa página web num navegador.
# pip install selenium

# Extrair todos os dados de citações contidos em:
